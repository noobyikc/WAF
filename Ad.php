	...
	<div class="contentpane">
    		<div class="panel panel-default" id="personal">
                    ...
                    <div class="panel-heading">
                        <div id="name">Advertising on WAF</div>
                    </div>
                    <div class="panel-body" style="font-size:20px; height:auto">
                        Posting Ads on WAF is simple.
                                <div class="form1" >
                                    <form class="white-pink"  action=""  method="post">
                                    <h1>Post An AD Forum 01 - Basic Details
                                ...
                                <div class="form1" >
			<form class="white-pink"  action=""  method="post">
			<h1>Post An AD Forum 02 - Audience
        			<span>Please fill all the texts in the fields.</span>
    			</h1>
	
				<label>
        			<span>Audience Country</span> 
				<input type="text" name="t1" size="40" input id="name"placeholder="Audience Country"/>
			</label>	
        ...
        <div class="form1" >
			<form class="white-pink"  action=""  method="post">
			<h1>Post An AD Forum 03 - Payment Details
        			<span>Please fill all the texts in the fields.</span>
    			</h1>
			...
			<input type="text" name="t3" size="20"input id="name" placeholder="Enter The Budget"/>
			</label>
