...
<?php
	...
	{
		$result = mysql_query("update register,profile set register.name =  '$name', profile.dob = '$dob', profile.country = '$country', profile.mobile = '$mobile' where register.email = '$mail' and profile.email = '$mail'") or die(mysql_error);
		if($result)
		{
